...
import { DEMO_MODE_PREFIX } from "@/services/labels";
...
export async function getCalendarEvents(
  ...
  // La implementación real vive en calendar-real.ts (server-only) para no
  // arrastrar cookies()/RLS al bundle de los client components.
  return (await import("@/services/calendar-real")).getCalendarEventsReal(weekStart);
}
...
export async function getAvailableSlots(
  ...
  return (await import("@/services/calendar-real")).getAvailableSlotsReal(courtId, date);
}
...
export async function getCustomers(
  ...
  return (await import("@/services/calendar-real")).getCustomersReal(_query);
}

export { DEMO_MODE_PREFIX, isDemoError as isDemoModeError } from "@/services/labels";
...
export async function createReservation(
  ...
  return (await import("@/services/calendar-real")).createReservationReal(_data);
}
...
export async function cancelReservation(
  ...
  return (await import("@/services/calendar-real")).cancelReservationReal(_reservationId, _reason);
}
